...
guarantee on the view 
\begin{figure}
\includegraphics[height = 8cm,width = 8cm]{picture1.png}
\label{fig:mesh1}
...
to calculate the final score \begin{equation}S^0 \end{equation} :
\begin{equation}
              S^o = 1-e^{-f}
       \end{equation}
...
line in the image. Let l ibe the length of the i th line and oi
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{formula1.png}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{formula3.png}
\end{figure}
...
video quality score S q .We have chosen to multiply the individual scores because we
...
to select video with different views.


\begin{enumerate}
    \item Determine the view similarity matrix V S by comparing cur-
rent frame with the frames stored in the history.
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{formula5.png}
\end{figure}
...
\begin{figure}[h]
\includegraphics[width=0.5\textwidth]{formula6.png}
\end{figure}
...
\begin{figure*}
\centering
\includegraphics[width=16cm,height = 10cm ]{figure11.png}
\caption{Selected frames from the recordings: (a-d) P1, (e-h) P2, (i-l) P3}
\end{figure*}
selection is triggered. We added this optimization to
...
lected frames for each performance.were allowed to replay the videos while answering the questions.
